...
import com.salesgen.model.InvoiceLine;
import com.salesgen.model.InvoiceLineModel;
import com.salesgen.view.InvFrame;
import com.salesgen.view.InvoiceHeaderTab;
import com.salesgen.view.InvoiceLineTab;
...
public class InvoiceListener implements ActionListener, ListSelectionListener  {
    ...
    public InvoiceListener(InvFrame frame) {
        this.frame = frame;
    }
    ...
    private void loadFile() {
        ...
        if (result == JFileChooser.APPROVE_OPTION) {
            ...
            try {
                ...
                JOptionPane.showMessageDialog(frame, "Please, Select Line File!", "Attension", JOptionPane.WARNING_MESSAGE);
                ...
                if (result == JFileChooser.APPROVE_OPTION) {
                    ...
                    frame.setInvoiceHeaderTableModel(new InvoiceHeadModel(frame.getInvoicesList()));
    ...
    private void saveData() {
        ...
        JOptionPane.showMessageDialog(frame, "Data Saved Succssefully", "Success", JOptionPane.INFORMATION_MESSAGE);
    ...
    private void invoicesTableRowSelected() {
        ...
        if (selectedRowIndex >= 0) {
            ...
            frame.setInvoiceLinesTableModel(new InvoiceLineModel(lines));
    ...
    private void displayNewInvoiceDialog() {
        frame.setHeaderDialog(new InvoiceHeaderTab(frame));
        frame.getHeaderDialog().setVisible(true);
    }

    private void displayNewLineDialog() {
        frame.setLineDialog(new InvoiceLineTab(frame));
    ...
    private void createInvOK() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(frame, "Attension, Wrong Date Format", "Error", JOptionPane.ERROR_MESSAGE);
            ex.printStackTrace();
        }
        displayInvoices();
    }
    ...
    private void deleteInvoice() {
        ...
        frame.getInvoiceHeaderTableModel().fireTableDataChanged();
        frame.setInvoiceLinesTableModel(new InvoiceLineModel(new ArrayList<InvoiceLine>()));
        frame.getInvLinesTable().setModel(frame.getInvoiceLinesTableModel());
        frame.getInvoiceLinesTableModel().fireTableDataChanged();
